"""MNIST Digit Recognition GUI

Interactive GUI for drawing digits and testing the trained CNN model.

Requirements:
- Trained model: mnist_model.hdf5 (created by running train.py)
...
- Predict button: Classify drawn digit
...
class DigitGUI:
    ...
    def _prepare_image(self) -> np.ndarray:
        """Prepare drawn image for model inference.
        
        Process:
        1. Downsample from 280x280 to 28x28 via average pooling
        2. Apply threshold to reduce noise
        3. Normalize to [0, 1] range
        4. Center digit using centroid shift
    ...
    def predict(self) -> None:
        """Run model inference on drawn digit and display results."""
...
def load_model(weights_path: str = 'mnist_model.hdf5') -> Model:
